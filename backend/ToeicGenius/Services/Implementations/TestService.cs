...
namespace ToeicGenius.Services.Implementations
{
    public class TestService : ITestService
    {
        ...
        public async Task<Result<TestStartResponseDto>> GetTestStartAsync(TestStartRequestDto request, Guid userId)
        {
            ...
            // Create TestResult for this session
        ...
        public async Task<Result<GeneralLRResultDto>> SubmitLRTestAsync(SubmitLRTestRequestDto request)
        {
            ...
            // Get test
            var test = await _uow.Tests.GetTestByIdAsync(request.TestId);
            if (test == null)
                return Result<GeneralLRResultDto>.Failure("Test not found");
            ...
            if (resultDetail == null)
                return Result<GeneralLRResultDto>.Failure("Failed to get test result details");
